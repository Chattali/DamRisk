...
public class BuscaMines {
	...
	public static void main(String[] args) {
		...
		do{
			...
			if (tauler[fila][col]==1){
				...
				taulerJugador[fila][col]=calculaMinas(fila,col,tauler);
					System.out.println(taulerJugador[fila][col]);
						//TODO Crida a la funció que feu de calcular les veines;
	...
	public static int calculaMinas (int fila, int col, int[][] tauler){
		// cont: variable que cuenta cuantas minas alrededor
		int cont=0;
		// variables que limita el cuadro de busqueda para no salir del tablero
		int maxfila=fila+1, minfila=fila-1, mincol=col-1, maxcol=col+1;
		// estudiaremos los casos extremos para no salir del cuadro
		switch (fila){
			case 0:
				minfila=0;
				break;
		...
		// esa funcion busca todas las filas y columnas dentro alrededor de la casilla 
		// y se alguna casilla esconde mina augmenta el valor de "cont"
